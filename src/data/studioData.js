...
export const ORG = {
  ...
  children: [
      ...
      children: [
        {
          ...
          color: 'design',
          children: [
            { id: 'luis-c', name: 'Luis C', role: 'Designer', color: 'design' },
            { id: 'ashlee-w', name: 'Ashlee W', role: 'Design Intern', color: 'design', intern: true },
            { id: 'cori-m', name: 'Cori M', role: 'Design Intern', color: 'design', intern: true },
          ],
        },
        {
          id: 'pride-sc',
          ...
          color: 'design',
          children: [
            { id: 'ryan-p', name: 'Ryan P', role: 'Designer', color: 'design' },
          ],
        },
        { id: 'sophia-j', name: 'Sophia J', role: 'Lead Designer', color: 'design' },
      ],
    },
    {
      id: 'grp-eng',
      ...
      color: 'engineering',
      children: [
        { id: 'carlos-t', name: 'Carlos T', role: 'Lead Engineer', color: 'engineering' },
        { id: 'rhianna', name: 'Rhianna', role: 'Lead Engineer', color: 'engineering' },
        {
          id: 'daniel-f',
          name: 'Daniel F',
          role: 'Lead Eng / Dev',
          color: 'engineering',
          children: [
            { id: 'michael-a', name: 'Michael A', role: 'Eng / Dev', color: 'engineering' },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          color: 'art',
          children: [
            { id: 'mia-c', name: 'Mia C', role: 'Artist', color: 'art' },
            { id: 'keolani-b', name: 'Keolani B', role: 'Artist', color: 'art' },
            { id: 'pedro-s', name: 'Pedro S', role: 'Art Intern', color: 'art', intern: true },
          ],
        },
        {
          id: 'hailey-h',
          ...
          color: 'art',
          children: [
            { id: 'liz-p', name: 'Liz P', role: 'Artist', color: 'art' },
            { id: 'ray-p', name: 'Ray P', role: 'Artist', color: 'art' },
            { id: 'juno-tc', name: 'Juno TC', role: 'Artist', color: 'art' },
          ],
        },
        {
          id: 'chris-c',
          ...
          color: 'art',
          children: [
            { id: 'luna', name: 'Luna', role: 'Artist', color: 'art' },
            { id: 'jacob', name: 'Jacob', role: 'Artist', color: 'art' },
            { id: 'vacant-2d', name: '2D Animator', role: 'Open role', color: 'vacant', vacant: true },
          ],
        },
      ],
    },
      ...
      children: [
        {
          ...
          color: 'uiux',
          children: [
            { id: 'adam-m', name: 'Adam M', role: 'UI/UX Eng Intern', color: 'uiux', intern: true },
            { id: 'katie-l', name: 'Katie L', role: 'UI/UX + SM Intern', color: 'uiux', intern: true },
          ],
        },
      ],
    },
    {
      ...
      color: 'audio',
      children: [
        { id: 'schwa', name: 'Schwa', role: 'Sound', color: 'audio' },
        { id: 'ayako', name: 'Ayako', role: 'Sound', color: 'audio' },
        { id: 'sandy-c', name: 'Sandy C', role: 'Music', color: 'audio' },
        { id: 'lauren-p', name: 'Lauren P', role: 'Narration', color: 'audio' },
        { id: 'michael-tb', name: 'Michael TB', role: 'Voice', color: 'audio' },
        { id: 'janey', name: 'Janey', role: 'Voice', color: 'audio' },
        { id: 'emmanuel', name: 'Emmanuel', role: '2nd Voice', color: 'audio' },
      ],
    },
  ],
}
...
export const COMPLIANCE_ITEMS = [
  ...
  { id: 'c-002', cat: 'employment', title: 'Pay transparency policy — CA SB 1162', desc: 'All CA job postings must include pay scale ranges. Revenue share % counts as compensation — must be disclosed on the 2D Animator listing.', priority: 'high', due: null, done: false },
  ...
  { id: 'c-004', cat: 'employment', title: 'CA AB 5 independent contractor classification', desc: 'All 33 revenue share participants reviewed against AB 5 ABC test. Creative professional exemptions documented.', priority: 'done', due: null, done: true },
  ...
  { id: 'c-007', cat: 'docs', title: 'Revenue Share Agreements — all 33 members signed', desc: 'Verify every active team member has a fully executed Revenue Share Agreement on file in DocuSign. 28 revenue share + 5 interns must all have documented agreements.', priority: 'high', due: null, done: false },
  { id: 'c-008', cat: 'docs', title: 'NDA renewal — expires June 1', desc: 'Studio-wide NDA template expires June 1. Requires review and re-execution with all 33 members and contractors.', priority: 'high', due: '2026-06-01', done: false },
  { id: 'c-009', cat: 'docs', title: 'NDAs on file — all current members', desc: 'Confirm all 33 active members have signed current NDA in DocuSign.', priority: 'high', due: null, done: false },
  ...
  { id: 'c-012', cat: 'safety', title: 'Ergonomics policy for workstations', desc: 'CA ergonomics regulation (Title 8, §5110) — important for animation/3D art studio with repetitive computer work across 33 remote and local members.', priority: 'medium', due: null, done: false },
  ...
  // Privacy
  { id: 'c-014', cat: 'privacy', title: 'CCPA privacy notice for collaborators', desc: 'CA CCPA requires a privacy notice explaining what personal data is collected and how it is used — applies to all 33 collaborators.', priority: 'high', due: null, done: false },
  ...
  // Agreements
  { id: 'c-017', cat: 'agreements', title: 'Revenue share % documented per member', desc: 'Each of the 28 revenue share team members must have their revenue share percentage formally documented in their signed agreement.', priority: 'high', due: null, done: false },
...
export const ONBOARDING_PHASES = [
  ...
  },
  {
    ...
    tasks: [
      { id: 'ob-07', title: 'Studio / virtual tour + team introductions', desc: 'Walk through all departments (in-person or via Discord video). Introduce to studio head and department leads.', owner: 'Manager + HR', done: false },
      ...
      { id: 'ob-10', title: 'Creative workflow walkthrough', desc: 'Walk through studio pipeline: brief → concept → production → review → delivery. Show asset naming conventions and handoff process.', owner: 'Creative Lead', done: false },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'ob-13', title: 'Review active studio projects + reel', desc: 'Walk through current project briefs, style guides, and studio reel. Department lead presents the aesthetic DNA and quality bar.', owner: 'Lead', done: false },
...
export const INTEGRATIONS = [
  ...
  },
  {
    ...
    icon: '📋',
    color: '#F1EFE8',
    desc: 'Lightweight applicant tracker for open roles. No ATS needed at current scale — Notion board handles pipeline, portfolio review, and candidate notes.',
    ...
    setupSteps: [
      ...
      { done: false, text: 'Create role page for 2D Animator' },
